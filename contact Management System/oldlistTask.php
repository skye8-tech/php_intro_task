                ...
                if ($row['status'] == "done") {
                    ...
                    <div class="task">
                                ...
                                <form action="action_comment.php" method="POST">
                                    <div class="comment-section">
                                        ...
                                        <input type="text" name="comment" class="task-comment" placeholder=" Add comment..."
                                            id="taskComment">
                                        <button name="action" value="create-comment" type="submit" class="btn btn-primary"
                                            id="saveComment">Save</button>
                        ...
                        <div class="action-icons">
                            <i class="fas fa-edit icon-action" data-toggle="modal"
                                data-target="#editTaskModal-<?php echo $row['id']; ?>" value="edit-task" name="action"
                                type="button"></i>
